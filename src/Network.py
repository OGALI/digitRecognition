...
class Network:
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        # ***why gradient starts at zero every time
        ...
        for x, y in mini_batch:
            ...
            # calculates the delta to be used for each point and updates nabla_b/w
            delta_nabla_b, delta_nabla_w = self.backprop(x, y)

            # adding the delta to the gradients to get new gradient
            # this is storing an array of nb gradients each iteration so then can average them
            # since gradient starts at zero, delta tells where to go from 0
    ...
    def backprop(self, x, y):
        ...
        # iterates over the list of biases and weights 1 by 1 and make list of activations and z
        for b, w in zip(self.biases, self.weights):
